...
export default function Source() {
  ...
  const accentClass =
    SOURCE_COLORS[srcInfo.key] ||
    "from-neon-cyan/10 to-dark-900 border-neon-cyan/10";
  ...
  return (
    ...
    >
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className={`px-5 py-8 bg-linear-to-br ${accentClass} border-b`}
      >
